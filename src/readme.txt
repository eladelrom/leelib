...
2. Added a Flex example (which can be useful for building AIR apps). Flex example shows how you can wrap other component in addition to the video itself, which can be found useful in certain use cases.
